 ...
 * (no FS reads happen).
 */
export async function composeInstructions(opts) {
...
function joinPieces(contributions, instructions) {
...
async function collectProjectContent(cwd) {
