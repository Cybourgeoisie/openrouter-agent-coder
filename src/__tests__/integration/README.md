...
| `single-tool-call-gemini.json`                                                                                                                                                                                | Recorded — `google/gemini-2.5-flash`    | Cross-provider proof that the recorder produces a replayable fixture for a non-Anthropic model.                                                                        |
